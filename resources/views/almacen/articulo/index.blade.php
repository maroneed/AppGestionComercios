...
<div class="row">
	<div class="clo-lg-8 col-md-8 col-sm-8 col-xs-12">
		<h3>Listado de Articulos
			...
			<a href="imprimir-articulo"  target="_blank"><button class= "btn btn-success">Reporte</button></a>
		</h3>
			...
			<table class= "table table-striped table-bordered table-condensed table-hover">
				...
				<tr>
					...
					<td>
						...
						<a href="{{url('codigoBarra',$art->id)}}"  target="_blank"><button class="btn btn-success">Imprimir codigo</button></a>
